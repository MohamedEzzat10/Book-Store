...
export default function Footer() {
  ...
  <div className="footer-social-media-icon">
    ...
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa obcaecati placeat ipsum veniam unde. Placeat consequuntur quo soluta laudantium! Alias ipsa aperiam nihil fugit obcaecati impedit, doloribus eligendi sint reiciendis?
      </p>
    </div>
    </div>
